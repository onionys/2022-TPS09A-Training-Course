...
*注意* 圖中左下角的 x-y-z 座標軸標示有誤(y-axis 是對的，但是x,z-axis 方向是錯的)，以講議內的設定為主。
...
下圖為晶體在 `tth=45, th = 45/2, phi = 0` 的情況下轉動 `chi` 角的情形。
...
下圖為在 Surface Normal 繞射點上進行 phi scan 時，倒晶格空間(固定繞射儀視角)的情形:
